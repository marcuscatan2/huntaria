...
| [summon-view.js](<../../summon-view.js>) | `BondSummonView` |
| [assets/summons/manifest.json](<../../assets/summons/manifest.json>) | Owned source/configuration; inspect before editing. |
