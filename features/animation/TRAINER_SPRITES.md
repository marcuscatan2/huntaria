...
The implemented trainer roster is Apprentice, Druid and Mage. No additional
class ID exists in runtime content yet; a new class needs its gameplay identity
and stable content ID before an art package is added.
...
`assets/art-v21/prompts.json` and `assets/art-v22/prompts.json`. Historical
...
checks four distinct walk/attack/cast images for Druid, Mage and both Apprentice
...
trainer prototypes. Mage and both Apprentice weapon sheets still need an
...
future class designs or commercial production assets.
