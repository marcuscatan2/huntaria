"""Isolated pass18 campaign content/recovery checks; never opens a personal profile."""
...
with sync_playwright() as pw:
    ...
    try:
        ...
        page.screenshot(path=str(ARTIFACTS/('pass18-campaign-journal-'+args.browser+'.png')),full_page=True)
    except Exception:
    ...
    (ARTIFACTS/('pass18-campaign-'+args.browser+'.json')).write_text(json.dumps(result,indent=2),encoding='utf-8')
    browser.close()
server.shutdown()
