...
with sync_playwright() as pw:
    ...
    try:
        ...
        page.screenshot(path=str(ARTIFACTS/'pass15-regression-combat.png'),full_page=True)
        ...
        page.screenshot(path=str(ARTIFACTS/'pass15-regression-picker.png'),full_page=True)
        ...
        page.screenshot(path=str(ARTIFACTS/'pass15-regression-inner-sea.png'),full_page=True)
        ...
        page.screenshot(path=str(ARTIFACTS/'pass15-regression-loot.png'),full_page=True)
        ...
        (ARTIFACTS/'pass15-regression-reference.json').write_text(json.dumps(manifest,indent=2,ensure_ascii=False),encoding='utf-8')
        ...
        page.screenshot(path=str(ARTIFACTS/'pass15-regression-mobile-picker.png'),full_page=True)
    ...
    (ARTIFACTS/('pass15-regression-'+args.browser+'.json')).write_text(json.dumps(report,indent=2),encoding='utf-8')
