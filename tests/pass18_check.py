...
with sync_playwright() as pw:
    ...
    try:
        ...
        page.clock.run_for(300);page.locator('.map-object.shop').click();page.clock.run_for(1000)
        check('Painted supply tent opens the shop',page.locator('#recovery-dialog').is_visible() and page.locator('[data-store-buy]').count()==5)
