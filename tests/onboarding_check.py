...
with sync_playwright() as pw:
    ...
    try:
        ...
        page.locator('.frame-destinations [data-menu-close]').click();page.locator('[data-world-menu="inventory"]').click()
        ...
        page.locator('.frame-destinations [data-menu-close]').click();page.locator('#field-withdraw').click()
        page.clock.run_for(3400)
        ...
        page.locator('.frame-destinations [data-menu-close]').click();page.reload();page.wait_for_function('!!window.BondApp')
        ...
        page.locator('.frame-destinations [data-menu-close]').click();page.clock.run_for(200)
