...
| Square maps, cities, portals, walking or scenery crops | [World](features/world/README.md) / [Exploration](features/exploration/README.md) | The 36-square grid connects border portals and saved position; [cities](features/world/CITIES.md) add overhead buildings/interiors, arrival healing and four-city waystones. |
