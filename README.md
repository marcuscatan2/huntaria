...
| Menus, upgrade badges, party, items or summoning | [Collection](features/collection/README.md) / [Game frame](features/party/GAME_FRAME.md) | Inner Sea owns party management and [Equipment](features/collection/EQUIPMENT.md): six trainer slots and individual held items. Red badges lead to spendable points. [Class Skill Tree](features/growth/TALENT_TREE.md) has prerequisite paths; [Dummy test](features/combat/TRAINING.md) measures party performance. |
