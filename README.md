...
Local browser prototype. Online accounts, authoritative rewards, multiplayer and payments are not implemented.
...
| Menus, upgrade badges, party, items or summoning | [Collection](features/collection/README.md) / [Game frame](features/party/GAME_FRAME.md) | Inner Sea owns party management and [Equipment](features/collection/EQUIPMENT.md): six trainer slots and individual held items. [Move lessons, city services and navigation](features/growth/COMPANION_MOVES.md). [Class Skill Tree](features/growth/TALENT_TREE.md) has prerequisite paths, including Apprentice training through Lv18; [Dummy test](features/combat/TRAINING.md) measures party performance. |
