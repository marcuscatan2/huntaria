...
| Square maps, cities, portals, walking or scenery crops | [World](features/world/README.md) / [Exploration](features/exploration/README.md) | The 36-square grid and four ghost-tower interiors connect portals and saved position; [cities](features/world/CITIES.md) add overhead buildings/interiors, arrival healing and four-city waystones. |
| Spawn density, wild levels, free healing | [Populations](features/population/README.md) / [Recovery](features/recovery/README.md) | Tripled roaming populations attack unless at least ten levels below the trainer; saved lives connect to camp and village services. |
