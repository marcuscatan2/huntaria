...
| Square maps, cities, stairs, walking or scenery crops | [World](features/world/README.md) / [Exploration](features/exploration/README.md) | The 36-square grid and four ghost-tower interiors connect routes and saved position; [landscapes and tower stonework](features/world/LANDSCAPES.md) define scenery; [cities](features/world/CITIES.md) add buildings, rooms, healing and waystones. |
