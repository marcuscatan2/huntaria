...
| Menus, upgrade badges, party, items or summoning | [Collection](features/collection/README.md) / [Game frame](features/party/GAME_FRAME.md) | Red badges lead from Bag to spendable points. Inner Sea owns party management; [Class Skill Tree](features/growth/TALENT_TREE.md) has illustrated prerequisite paths. [Dummy test](features/combat/TRAINING.md) measures party performance. |
