...
def main():
    ...
    try:
        if args.command == "doctor":
            ...
            for suite in ("boundaries", "combat-workbooks", "monster-progression", "equipment", "talent-tree", "apprentice-tree", "companion-services", "mechanics", "ui", "city-world", "field-encounters", "relic-quest", "campaign", "opening", "onboarding", "sprites", "trainer-animation", "field-polish", "landscapes", "experience", "farm-classes", "game-frame", "menu-upgrades", "server-refresh", "player-experience", "runtime", "client-build"):
