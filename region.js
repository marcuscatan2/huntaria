...
host.innerHTML='<canvas id="world-ground" aria-hidden="true"></canvas><div id="world-actors"></div><div class="region-map-heading"></div><div id="world-quest" class="world-quest"><small>MAIN QUEST</small><span id="world-objective"></span><small id="world-objective-location" class="world-objective-location"></small></div><button id="world-minimap" aria-label="Local map. Choose a destination."><canvas width="160" height="120" aria-hidden="true"></canvas><span id="world-map-name"></span></button><button id="open-atlas" class="world-atlas-button" aria-label="Open World Atlas"><span aria-hidden="true">✦</span><small>WORLD ATLAS</small></button><span id="world-coordinates" aria-hidden="true"></span><div id="world-weather"></div><div id="world-load-state" role="status"></div><div id="world-status" role="status" aria-live="polite"></div><nav id="world-action-menu" aria-label="Game menu"><button data-world-menu="region" class="selected" aria-current="page"><img class="destination-icon" src="assets/interface/explore.svg" alt="" aria-hidden="true" width="36" height="36"><small>Explore</small></button><button data-world-menu="inventory"><img class="destination-icon" src="assets/interface/bag.svg" alt="" aria-hidden="true" width="36" height="36"><small>Bag</small></button><button data-world-menu="collection"><img class="destination-icon" src="assets/interface/inner-sea.svg" alt="" aria-hidden="true" width="36" height="36"><small>Inner Sea</small></button></nav><div id="region-toast" class="region-toast" hidden></div>';
