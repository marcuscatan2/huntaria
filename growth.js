/* Class talents and eighteen-node companion mastery use separate budgets. */
(function(root){
'use strict';
...
function clean(type,raw,points=999,legacyClass=false){
...
function nodes(type,legacyClass=false){
