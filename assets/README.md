...
- [Item artwork](items/manifest.json): 204 original compact SVG equipment, held-item and class quest-weapon
  icons; generated by `scripts/item_icons.py` with 96-unit view boxes.
