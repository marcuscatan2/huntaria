...
- [ ] F-010-AC1: Each of the four classes exposes 15 workbook talents with stable IDs, rank-2 upgrades and rank-1 capstones across three connected branches. At least100 monster species expose24 single-rank talents across three connected eight-node branches. Owned companions unlock their tree at individual level31; the innate is free and branch capstones are mutually exclusive.
- [ ] F-010-AC2: Each individual owns separate investment in its species template: thirteen level points at31,34,36,39,41,44,46,48,51,53,56,58,60, plus one for Tidecrown and one for the relic quest, capped at15. Quest points also wait for individual level31; no early talent prompts appear. Class trees unlock with Lv20 transformation: two points at20, one every three levels through59, capped at15. No purchase exceeds budget/cap or bypasses prerequisites. Trainer respec is free; a city companion reset costs one matching Echo and clears active/deferred selections. Migration refunds retired generic nodes, preserves valid selections above the new budget in deferredGrowth for automatic reactivation, and preserves earned budgets and frozen encounter rules.
...
- [ ] F-010-AC4: At the locked progression budgets, at least two distinct development paths per class are viable and every species has one documented useful path. Trainer respec remains free and companion resets require a matching Echo; the UI does not imply all nodes can be maxed.
