...
| Delivery resilience | Chunk LRU, two regional and three shared landscape sheets (tower art loads on first visit), ground fallback, silent progressive loading and concise failure/retry feedback | Bounded map transitions; aborted asset request/retry; real-time browser sample |
...
atlases add about 12 MiB; the lazily loaded tower stonework adds 6 MiB. The material atlas plus
